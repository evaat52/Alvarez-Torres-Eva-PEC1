...
Se analizaron datos de 39 pacientes sometidos a cirugía bariátrica (bypass gástrico o gastrectomía tubular) con el objetivo de evaluar la evolución de variables fisiológicas y metabolómicas a lo largo del tiempo. Se construyó un objeto SummarizedExperiment para organizar los datos y se realizó un análisis exploratorio mediante gráficos de tendencias, PCA, heatmaps y pruebas estadísticas.
...
El dataset incluía 39 pacientes y 690 variables, de las cuales 6 correspondían a metadatos (edad, sexo, grupo, tipo de cirugía) y las restantes a medidas fisiológicas y metabolómicas repetidas en cuatro tiempos: T0 (antes de la cirugía), T2, T4 y T5. 
...
Se llevó a cabo un análisis exploratorio estructurado en:
  ...
  2.	Exploración homogeneidad de grupos de tratamiento
      ...
      b.	Selección de los 30 metabolitos con mayor variabilidad y representación de heatmap para evaluar posibles clusters. 
...
La muestra incluyó 39 pacientes, 27 mujeres y 12 hombres, distribuidos en 24 pacientes en el grupo 1 y 15 en el grupo 2. En cuanto al tipo de cirugía, 26 fueron sometidos a bypass gástrico y 13 a gastrectomía tubular. La distribución por edad fue homogénea entre grupos quirúrgicos **(figura 1)**
...
El análisis de componentes principales (PCA) a tiempo 0  (T0) no mostró una separación clara entre los grupos ni entre tipos de cirugía, lo que sugiere una adecuada homogeneidad basal entre las cohortes. Esta observación se refuerza con el heatmap generado a partir de los 30 metabolitos con mayor variabilidad, el cual evidenció patrones de expresión heterogéneos pero sin agrupamientos sistemáticos atribuibles a la técnica quirúrgica o al grupo. **(Imágenes 2 y 3)**
...
La ausencia de diferencias iniciales entre grupos sugiere que los efectos observados son atribuibles a la intervención y no a condiciones basales distintas.
...
Se recomienda ampliar la muestra y realizar un seguimiento más prolongado para confirmar los resultados observados.
...
### Pregunta 2: Crear SummarizedExperiment object
...
save(se, file = "data/SummarizedExperiment.Rda")
```
